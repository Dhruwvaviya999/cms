...
import { ACTIONS, HTTP_STATUS } from "../constant.js";
import { generateContentWithGemini } from "../services/generatecontent.service.js";
...
export const contentWithId = asyncHandler(async (req, res) => {
  logger.info(
