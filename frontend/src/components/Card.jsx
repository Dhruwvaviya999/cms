  ...
  return (
    <Link to={feature.link}>
      <div className="shadow-xl bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
        <div
          className={`bg-linear-to-br ${feature.gradient} p-8 min-h-57.5`}
        >
        ...
        <div className="p-6">
          <button
            className={`bg-linear-to-br ${feature.gradient} px-6 py-3 rounded-lg text-white w-full block text-center font-semibold hover:opacity-90 transition-opacity`}
          >
            Get Started →
          </button>
        </div>
