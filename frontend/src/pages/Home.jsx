...
import { ArrowIcon, ImageIcon, WriteIcon } from "../components/Icons";
          ...
          <div className="text-center">
            ...
            {!isAuthenticated && (
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link
                  to="/register"
                  className="px-6 py-2.5 bg-linear-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-lg hover:from-indigo-500 hover:to-purple-500 transition-all duration-200"
                >
                  Get Started Free
                </Link>
                <Link
      ...
      {isAuthenticated && (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <Link
              to="/content"
              className="group relative bg-linear-to-br from-blue-600/20 to-cyan-600/20 rounded-lg p-5 border border-blue-500/30 hover:border-blue-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20"
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-linear-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <Link
              to="/image"
              className="group relative bg-linear-to-br from-purple-600/20 to-pink-600/20 rounded-lg p-5 border border-purple-500/30 hover:border-purple-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20"
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-linear-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
